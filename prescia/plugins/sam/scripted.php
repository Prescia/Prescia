<?	# -------------------------------- SAM - Semanti automato

class mod_sam extends CscriptedModule  {

	var $name = "sam"; // SET THIS TO THE SCRIPT NAME either here (inherited module) or the construct!
